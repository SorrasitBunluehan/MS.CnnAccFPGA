...
HD_PWD='D:/Vivado_Project/MS.CnnAccFPGA/Vivado_proj/conv_acc_proj/conv_acc_proj.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ConvAccelerator.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ConvAccelerator.tcl
