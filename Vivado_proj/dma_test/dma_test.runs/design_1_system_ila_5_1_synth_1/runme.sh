...
HD_PWD='D:/Vivado_Project/MS.CnnAccFPGA/Vivado_proj/dma_test/dma_test.runs/design_1_system_ila_5_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_system_ila_5_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_system_ila_5_1.tcl
