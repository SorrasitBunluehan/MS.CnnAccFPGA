...
HD_PWD='D:/Vivado_Project/MS.CnnAccFPGA/Vivado_proj/dma_test/dma_test.runs/design_1_MyAcc_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_MyAcc_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_MyAcc_0_0.tcl
