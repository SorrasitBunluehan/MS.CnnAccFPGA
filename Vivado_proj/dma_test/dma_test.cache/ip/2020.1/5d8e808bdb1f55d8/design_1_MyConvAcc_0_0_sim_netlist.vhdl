...
entity decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_main_fsm is
  port (
    \FSM_onehot_c_state_reg[2]_0\ : out STD_LOGIC;
    Q : out STD_LOGIC_VECTOR ( 1 downto 0 );
    main_en_test : out STD_LOGIC;
    \FSM_onehot_c_state_reg[2]_1\ : out STD_LOGIC;
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_main_fsm is
  ...
  signal \^fsm_onehot_c_state_reg[2]_0\ : STD_LOGIC;
  ...
  signal main_en_reg_i_2_n_0 : STD_LOGIC;
  ...
  attribute FSM_ENCODED_STATES of \FSM_onehot_c_state_reg[0]\ : label is "l_w:010000,w_prep:000010,x_prep:000100,idle:000001,l_x:100000,compute:001000";
  attribute FSM_ENCODED_STATES of \FSM_onehot_c_state_reg[1]\ : label is "l_w:010000,w_prep:000010,x_prep:000100,idle:000001,l_x:100000,compute:001000";
  attribute FSM_ENCODED_STATES of \FSM_onehot_c_state_reg[2]\ : label is "l_w:010000,w_prep:000010,x_prep:000100,idle:000001,l_x:100000,compute:001000";
  attribute SOFT_HLUTNM of \col[7]_i_1\ : label is "soft_lutpair1";
  attribute XILINX_LEGACY_PRIM : string;
  attribute XILINX_LEGACY_PRIM of input_mux_reg : label is "LD";
  attribute SOFT_HLUTNM of input_mux_reg_i_1 : label is "soft_lutpair2";
  attribute XILINX_LEGACY_PRIM of main_en_reg : label is "LD";
  attribute SOFT_HLUTNM of main_en_reg_i_2 : label is "soft_lutpair2";
  attribute SOFT_HLUTNM of \q[31]_i_1\ : label is "soft_lutpair1";
begin
  \FSM_onehot_c_state_reg[2]_0\ <= \^fsm_onehot_c_state_reg[2]_0\;
...
\col[7]_i_1\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"2"
        ...
        port map (
      I0 => XAXIS_TVALID,
      I1 => \^fsm_onehot_c_state_reg[2]_0\,
      O => E(0)
    );
input_mux_reg: unisim.vcomponents.LDCE
    generic map(
      ...
      CLR => '0',
      D => \^q\(1),
      G => input_mux_reg_i_1_n_0,
      GE => '1',
      Q => \^fsm_onehot_c_state_reg[2]_0\
    );
...
main_en_reg: unisim.vcomponents.LDCE
    generic map(
      ...
      G => main_en_reg_i_2_n_0,
      GE => '1',
      Q => \^main_en_test\
    );
main_en_reg_i_1: unisim.vcomponents.LUT2
    generic map(
      INIT => X"E"
    )
        port map (
...
main_en_reg_i_2: unisim.vcomponents.LUT2
    generic map(
      INIT => X"E"
    )
        port map (
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_w_sticker is
  ...
  attribute SOFT_HLUTNM : string;
  attribute SOFT_HLUTNM of addr_trg_i_1 : label is "soft_lutpair11";
  ...
  attribute SOFT_HLUTNM of \col[3]_i_1\ : label is "soft_lutpair3";
  attribute SOFT_HLUTNM of \col[4]_i_1\ : label is "soft_lutpair3";
  attribute SOFT_HLUTNM of \col[6]_i_1\ : label is "soft_lutpair8";
  attribute SOFT_HLUTNM of \col[7]_i_2\ : label is "soft_lutpair8";
  attribute XILINX_LEGACY_PRIM : string;
  ...
  attribute SOFT_HLUTNM of data_valid_i_3 : label is "soft_lutpair10";
  attribute SOFT_HLUTNM of \o_a[0,0][31]_i_2\ : label is "soft_lutpair5";
  attribute SOFT_HLUTNM of \row[0]_i_1\ : label is "soft_lutpair7";
  attribute SOFT_HLUTNM of \row[1]_i_1\ : label is "soft_lutpair7";
  attribute SOFT_HLUTNM of \row[3]_i_1\ : label is "soft_lutpair4";
  attribute SOFT_HLUTNM of \row[4]_i_1\ : label is "soft_lutpair4";
  attribute SOFT_HLUTNM of \row[6]_i_1\ : label is "soft_lutpair9";
  attribute SOFT_HLUTNM of \row[7]_i_2\ : label is "soft_lutpair9";
  attribute SOFT_HLUTNM of \s_c[0]_i_1\ : label is "soft_lutpair11";
  attribute SOFT_HLUTNM of we_sel_i_1 : label is "soft_lutpair10";
begin
  XAXIS_ARSTN_0 <= \^xaxis_arstn_0\;
\FSM_onehot_c_state[2]_i_2\: unisim.vcomponents.LUT1
    generic map(
      INIT => X"1"
    )
        port map (
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_wgu is
  ...
  attribute SOFT_HLUTNM : string;
  attribute SOFT_HLUTNM of \mem_addr[1]_i_1\ : label is "soft_lutpair12";
  attribute SOFT_HLUTNM of \mem_addr[2]_i_1\ : label is "soft_lutpair12";
begin
  AR(0) <= \^ar\(0);
...
stick: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_w_sticker
     port map (
      ...
      \o_a_reg[0,0][0]_0\ => \o_a_reg[0,0][0]\,
      s_c => s_c,
      we0 => stick_n_0,
      we1 => we1,
      we_sel => we_sel
...
agu_dut: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_AGU
     port map (
      ...
      XAXIS_TDATA(31 downto 0) => XAXIS_TDATA(31 downto 0),
      agu_out_test(31 downto 0) => agu_out_test(31 downto 0),
      \q_reg[31]\ => \^main_en_test\,
      \q_reg[31]_0\ => main_fsm_dut_n_4
    );
main_fsm_dut: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_main_fsm
     port map (
      AR(0) => wgu_dut_n_0,
      E(0) => wgu_tvalid,
      \FSM_onehot_c_state_reg[2]_0\ => \^input_mux_test\,
      \FSM_onehot_c_state_reg[2]_1\ => main_fsm_dut_n_4,
      Q(1 downto 0) => Q(1 downto 0),
      XAXIS_ACLK => XAXIS_ACLK,
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix is
  ...
  signal \^fsm_state_test\ : STD_LOGIC_VECTOR ( 1 downto 0 );
...
begin
  ...
  compute_en_test <= \<const0>\;
  fsm_state_test(2) <= \<const0>\;
...
U0: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_acc_wrapper
     port map (
      Q(1 downto 0) => \^fsm_state_test\(1 downto 0),
      XAXIS_ACLK => XAXIS_ACLK,
      XAXIS_ARSTN => XAXIS_ARSTN,
      XAXIS_TDATA(31 downto 0) => XAXIS_TDATA(31 downto 0),
      XAXIS_TLAST => XAXIS_TLAST,
