...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_main_fsm is
  signal \^fsm_sequential_c_state_reg[1]_0\ : STD_LOGIC;
  ...
  attribute SOFT_HLUTNM of \FSM_sequential_n_state_reg[0]_i_1\ : label is "soft_lutpair3";
  ...
  attribute SOFT_HLUTNM of \col[7]_i_1\ : label is "soft_lutpair6";
  attribute XILINX_LEGACY_PRIM of compute_en_reg : label is "LD";
  attribute SOFT_HLUTNM of compute_en_reg_i_1 : label is "soft_lutpair5";
  attribute SOFT_HLUTNM of \fsm_state_test[0]_INST_0\ : label is "soft_lutpair5";
  attribute SOFT_HLUTNM of \fsm_state_test[1]_INST_0\ : label is "soft_lutpair2";
  ...
  attribute SOFT_HLUTNM of input_mux_reg_i_1 : label is "soft_lutpair7";
  attribute SOFT_HLUTNM of input_mux_reg_i_2 : label is "soft_lutpair7";
  attribute XILINX_LEGACY_PRIM of main_en_reg : label is "LD";
  attribute SOFT_HLUTNM of main_en_reg_i_1 : label is "soft_lutpair2";
  attribute SOFT_HLUTNM of \q[31]_i_1\ : label is "soft_lutpair6";
  attribute XILINX_LEGACY_PRIM of tready_reg : label is "LD";
  attribute SOFT_HLUTNM of tready_reg_i_1 : label is "soft_lutpair4";
  ...
  attribute SOFT_HLUTNM of w_addr_c_en_reg_i_1 : label is "soft_lutpair4";
begin
  \FSM_sequential_c_state_reg[1]_0\ <= \^fsm_sequential_c_state_reg[1]_0\;
...
\col[7]_i_1\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"2"
        ...
        port map (
      I0 => XAXIS_TVALID,
      I1 => \^fsm_sequential_c_state_reg[1]_0\,
      O => E(0)
    );
...
input_mux_reg: unisim.vcomponents.LDCE
    generic map(
      ...
      GE => '1',
      Q => \^fsm_sequential_c_state_reg[1]_0\
    );
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_w_sticker is
  ...
  attribute SOFT_HLUTNM : string;
  attribute SOFT_HLUTNM of addr_trg_i_1 : label is "soft_lutpair16";
  attribute SOFT_HLUTNM of \col[0]_i_1\ : label is "soft_lutpair11";
  attribute SOFT_HLUTNM of \col[1]_i_1\ : label is "soft_lutpair10";
  attribute SOFT_HLUTNM of \col[2]_i_1\ : label is "soft_lutpair11";
  attribute SOFT_HLUTNM of \col[3]_i_1\ : label is "soft_lutpair8";
  attribute SOFT_HLUTNM of \col[4]_i_1\ : label is "soft_lutpair8";
  attribute SOFT_HLUTNM of \col[6]_i_1\ : label is "soft_lutpair13";
  attribute SOFT_HLUTNM of \col[7]_i_2\ : label is "soft_lutpair13";
  attribute XILINX_LEGACY_PRIM : string;
  ...
  attribute SOFT_HLUTNM of data_valid_i_3 : label is "soft_lutpair15";
  attribute SOFT_HLUTNM of \o_a[0,0][31]_i_2\ : label is "soft_lutpair10";
  attribute SOFT_HLUTNM of \row[0]_i_1\ : label is "soft_lutpair12";
  attribute SOFT_HLUTNM of \row[1]_i_1\ : label is "soft_lutpair12";
  attribute SOFT_HLUTNM of \row[3]_i_1\ : label is "soft_lutpair9";
  attribute SOFT_HLUTNM of \row[4]_i_1\ : label is "soft_lutpair9";
  attribute SOFT_HLUTNM of \row[6]_i_1\ : label is "soft_lutpair14";
  attribute SOFT_HLUTNM of \row[7]_i_2\ : label is "soft_lutpair14";
  attribute SOFT_HLUTNM of \s_c[0]_i_1\ : label is "soft_lutpair16";
  attribute SOFT_HLUTNM of we_sel_i_1 : label is "soft_lutpair15";
begin
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_wgu is
  ...
  attribute SOFT_HLUTNM : string;
  attribute SOFT_HLUTNM of \FSM_sequential_n_state_reg[2]_i_3\ : label is "soft_lutpair18";
  attribute SOFT_HLUTNM of \mem_addr[0]_i_1\ : label is "soft_lutpair18";
  attribute SOFT_HLUTNM of \mem_addr[1]_i_1\ : label is "soft_lutpair17";
  attribute SOFT_HLUTNM of \mem_addr[2]_i_1\ : label is "soft_lutpair17";
begin
  AR(0) <= \^ar\(0);
...
agu_dut: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_AGU
     port map (
      ...
      \q_reg[31]_0\ => main_fsm_dut_n_5
    );
main_fsm_dut: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_main_fsm
     port map (
      AR(0) => wgu_dut_n_0,
      E(0) => wgu_tvalid,
      \FSM_sequential_c_state_reg[1]_0\ => \^input_mux_test\,
      \FSM_sequential_c_state_reg[2]_0\ => wgu_dut_n_1,
      XAXIS_ACLK => XAXIS_ACLK,
