...
HD_PWD='D:/Vivado_Project/MS.CnnAccFPGA/Vivado_proj/nbitadder/nbitadder.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log nbitadder.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source nbitadder.tcl
