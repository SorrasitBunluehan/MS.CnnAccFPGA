...
HD_PWD='D:/Vivado_Project/MS.CnnAccFPGA/Vivado_proj/agu_sim/agu_sim.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log AGU.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source AGU.tcl
