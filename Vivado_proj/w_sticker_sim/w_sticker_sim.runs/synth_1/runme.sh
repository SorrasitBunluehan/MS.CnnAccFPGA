...
HD_PWD='D:/Vivado_Project/MS.CnnAccFPGA/Vivado_proj/w_sticker_sim/w_sticker_sim.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log w_sticker.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source w_sticker.tcl
