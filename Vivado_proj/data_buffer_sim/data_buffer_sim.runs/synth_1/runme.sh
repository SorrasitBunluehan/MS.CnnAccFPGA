...
HD_PWD='D:/Vivado_Project/MS.CnnAccFPGA/Vivado_proj/data_buffer_sim/data_buffer_sim.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log data_buffer.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source data_buffer.tcl
