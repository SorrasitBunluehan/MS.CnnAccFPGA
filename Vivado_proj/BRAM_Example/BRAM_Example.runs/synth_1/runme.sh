...
HD_PWD='D:/Vivado_Project/MS.CnnAccFPGA/Vivado_proj/BRAM_Example/BRAM_Example.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log rams_01.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source rams_01.tcl
