...
HD_PWD='D:/Vivado_Project/MS.CnnAccFPGA/Vivado_proj/main_fsm_syn/main_fsm_syn.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log main_fsm.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source main_fsm.tcl
