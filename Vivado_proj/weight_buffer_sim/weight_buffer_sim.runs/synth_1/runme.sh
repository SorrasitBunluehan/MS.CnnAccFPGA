...
HD_PWD='D:/Vivado_Project/MS.CnnAccFPGA/Vivado_proj/weight_buffer_sim/weight_buffer_sim.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log weight_buffer.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source weight_buffer.tcl
