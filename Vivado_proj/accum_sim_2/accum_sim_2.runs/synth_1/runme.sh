...
HD_PWD='D:/Vivado_Project/MS.CnnAccFPGA/Vivado_proj/accum_sim_2/accum_sim_2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ACCU.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ACCU.tcl
