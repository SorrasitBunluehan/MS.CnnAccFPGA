...
HD_PWD='D:/Vivado_Project/MS.CnnAccFPGA/Vivado_proj/bram_dp_tb/bram_dp_tb.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log BRAM_DP.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source BRAM_DP.tcl
