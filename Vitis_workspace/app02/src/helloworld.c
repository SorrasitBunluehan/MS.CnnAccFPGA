...
#define KERNEL_BUFFER_BASE  (TX_BUFFER_BASE + 0X00001000)			//0x0120_1000
...
void Data_init(void)
{
	...
	*_kernelptr = 0x00000600;
	...
	/* Flush the buffers before the DMA transfer, in case the Data Cache
		 * is enabled
		 */
	Xil_DCacheFlushRange((UINTPTR)INPUT_BUFFER_BASE, (14*14*2)*4);
	Xil_DCacheFlushRange((UINTPTR)RX_BUFFER_BASE, (14*14*2)*4);
	Xil_DCacheFlushRange((UINTPTR)KERNEL_BUFFER_BASE, (4*4*2)*4);
