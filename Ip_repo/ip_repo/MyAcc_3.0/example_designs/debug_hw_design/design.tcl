...
proc create_ipi_design { offsetfile design_name } {
	...
	# Connect all clock & reset of MyAcc_0 slave interfaces..
	connect_bd_intf_net [get_bd_intf_pins axi_peri_interconnect/M00_AXI] [get_bd_intf_pins MyAcc_0/S01_AXI]
	connect_bd_net [get_bd_pins MyAcc_0/s01_axi_aclk] [get_bd_pins sys_clk_0/clk_out1]
	connect_bd_net [get_bd_pins MyAcc_0/s01_axi_aresetn] [get_bd_pins sys_reset_0/peripheral_aresetn]

	# Connect all clock & reset of MyAcc_0 streaming interfaces..
	connect_bd_net [get_bd_pins MyAcc_0/s00_axis_aclk] [get_bd_pins sys_clk_0/clk_out1]
	connect_bd_net [get_bd_pins MyAcc_0/s00_axis_aresetn] [get_bd_pins sys_reset_0/peripheral_aresetn]
	connect_bd_net [get_bd_pins MyAcc_0/m00_axis_aclk] [get_bd_pins sys_clk_0/clk_out1]
	connect_bd_net [get_bd_pins MyAcc_0/m00_axis_aresetn] [get_bd_pins sys_reset_0/peripheral_aresetn]


	# Auto assign address
	assign_bd_address

	# Copy all address to MyAcc_v3_0_include.tcl file
	set bd_path [get_property DIRECTORY [current_project]]/[current_project].srcs/[current_fileset]/bd
	upvar 1 $offsetfile offset_file
	set offset_file "${bd_path}/MyAcc_v3_0_include.tcl"
	set fp [open $offset_file "w"]
	puts $fp "# Configuration address parameters"

	set offset [get_property OFFSET [get_bd_addr_segs /jtag_axi_0/Data/SEG_MyAcc_0_S01_AXI_* ]]
...
set hw_test_file ${ip_path}/example_designs/debug_hw_design/MyAcc_v3_0_hw_test.tcl
...
for { set i 1 } { 1 } { incr i } {
	set design_name "MyAcc_v3_0_hw_${i}"
