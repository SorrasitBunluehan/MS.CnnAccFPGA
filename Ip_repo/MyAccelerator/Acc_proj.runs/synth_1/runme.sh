...
HD_PWD='D:/Vivado_Project/MS.CnnAccFPGA/Ip_repo/MyAccelerator/Acc_proj.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log acc_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source acc_wrapper.tcl
