...
HD_PWD='D:/Master_Thesis/Vivado/HwProj/HwProj.runs/design_1_ConvAccelerator_0_9_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_ConvAccelerator_0_9.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_ConvAccelerator_0_9.tcl
